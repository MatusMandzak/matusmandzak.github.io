...
#### Stage 2: The Self-Modifying Exit Handler Chain
After setting up exit fncs array we call exit to start execution and write `system` with `/bin/sh` as an argument to our predefined spot.
